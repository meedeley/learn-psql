-- Active: 1736276969157@@127.0.0.1@5432@ecommerce
...
-- use GIN INDEX, bcs GIN fit for array searches
CREATE INDEX idx_products_tags ON products USING GIN (tags);

SELECT * FROM products;
SELECT * FROM products WHERE tags && ARRAY['electronics', 'books']; -- Products with either select
...
('1d611e37-caeb-4e58-86a7-1928ab8aa98a', (SELECT id FROM products WHERE name = 'Laptop X1'), 2);

...
-- ARITMETIC OPERATOR
SELECT id, name, price + 1.000 AS after_adjust, price as real_price FROM products;  
SELECT id, name, price - 1.000 AS before_adjut, price as real_price FROM products;  
SELECT id, name, price * 0.5 AS discount, price as real_price FROM products; 
SELECT id, name, price / 2.0 AS discount, price as real_price FROM products;  

-- STRING OPERATOR
SELECT id, name || ' Sedap Spesial' as new_name FROM products WHERE id = 1;
-- WHERE CLAUSE
SELECT * FROM products WHERE name = 'Mie Goreng Original';
-- WHERE OPERATOR 
SELECT * FROM products WHERE price > 10.000;
-- AND OR WHERE OPERAOTR
SELECT * FROM products WHERE price = 10.000 AND name = 'Mie Goreng Original';
SELECT * FROM products WHERE price = 10.000 OR price = 12.000;

-- WHERE BETWEEN OPERATOR (to search between value)
SELECT id, name, price FROM products WHERE price BETWEEN 10.000 AND 12.000;
SELECT id, name, price FROM products WHERE price BETWEEN 12.000 AND 15.000;
-- WHERE NOT BETWEEN
SELECT id, name, price FROM products WHERE price NOT BETWEEN 10.000 AND 12.000;

-- WHERE IN (to search same value)
SELECT id, name, price FROM products WHERE price IN(15.000);
...
-- LIMIT CLAUSE
/*
Querying all data its not best practice, the best way we can do is us limit to quering data
*/
...
-- INSERT TO discounts
INSERT INTO discounts ("name", "price") VALUES 
    ('PROMO AKHIR TAHUN', 20000),
    (null, 40000);

-- WHERE NULL OPERATOR
SELECT * FROM discounts WHERE name IS NULL;

-- WHERE NOT NULL OPERATOR
SELECT * FROM discounts WHERE name IS NOT NULL;